...
class InterviewScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        $arrSchedule = [];
        $today_date = date('m');
        $current_month_event = InterviewSchedule::select('id', 'candidate','date','employee', 'time','comment')->whereNotNull(['date'])->whereMonth('date',$today_date)->get();
        ...
        return view('interviewSchedule.index', compact('arrSchedule', 'schedules','current_month_event'));
    }
