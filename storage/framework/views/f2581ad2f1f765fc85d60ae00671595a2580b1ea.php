    ...
    <!--     <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
                ...
                <div class="card-body text-center client-box">
                    ...
                    <a href="#"
                        class="text-sm text-muted mb-3"><?php echo e(ucfirst(!empty($employee->designation) ? $employee->designation->name : '')); ?></a>
                    <div class="row mt-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inditama/hr.inditama.co.id/resources/views/employee/profile.blade.php ENDPATH**/ ?>