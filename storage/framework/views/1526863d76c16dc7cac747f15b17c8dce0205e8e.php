...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Company Policy')): ?>
        <a href="#" data-url="<?php echo e(route('company-policy.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Company Policy')); ?>" data-size="lg" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inditama/hr.inditama.co.id/resources/views/companyPolicy/index.blade.php ENDPATH**/ ?>