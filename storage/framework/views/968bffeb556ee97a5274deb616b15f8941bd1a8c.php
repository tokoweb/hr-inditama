    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('department', $departments, null, ['class' => 'form-control select2 department_id', 'required' => 'required'])); ?>
...
<?php /**PATH /home/u5960582/public_html/hr/resources/views/indicator/create.blade.php ENDPATH**/ ?>