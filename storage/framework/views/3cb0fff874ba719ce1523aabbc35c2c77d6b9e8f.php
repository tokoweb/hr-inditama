...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Competencies')): ?>
        <a href="#" data-url="<?php echo e(route('competencies.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Competencies')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                        ...
                        <tbody>
                            <?php $__currentLoopData = $competencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(!empty($competency->getPerformance_type->name) ? $competency->getPerformance_type->name : '-'); ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Competencies')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                        data-url="<?php echo e(URL::to('competencies/' . $competency->id . '/edit')); ?>"
                                                        data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
                                                        data-title="<?php echo e(__('Edit Competencies')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5960582/public_html/hr/resources/views/competencies/index.blade.php ENDPATH**/ ?>