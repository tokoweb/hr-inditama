            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> <?php echo e(__('Copyright')); ?>
                        ...
                        <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'HRMGo SaaS')); ?>

                        <?php echo e(date('Y')); ?> | Design By HRMGo </p>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/inditama/hr.inditama.co.id/resources/views/layouts/landing.blade.php ENDPATH**/ ?>