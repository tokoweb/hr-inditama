                            ...
                            <div class="row">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Set Salary')): ?>
                                    <div class="col-6 text-end">
                                        ...
                                        <a  data-url="<?php echo e(route('employee.basic.salary', $employee->id)); ?>"
                                            data-ajax-popup="true" data-title="<?php echo e(__('Set Basic Sallary')); ?>"
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Allowance')): ?>
                                    <div class="col-6 text-end">
                                        <a  data-url="<?php echo e(route('allowances.create', $employee->id)); ?>"
                                            data-ajax-popup="true" data-title="<?php echo e(__('Create Allowance')); ?>"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                            ...
                            <div class="row">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Commission')): ?>
                                    <div class="col text-end">
                                        <a  data-url="<?php echo e(route('commissions.create', $employee->id)); ?>"
                                            data-ajax-popup="true" data-title="<?php echo e(__('Create Commission')); ?>"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                            data-bs-original-title="<?php echo e(__('Create')); ?>">
                                            <i class="ti ti-plus"></i>
                                        </a>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Loan')): ?>
                                    <div class="col text-end">
                                        <a  data-url="<?php echo e(route('loans.create', $employee->id)); ?>"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Saturation Deduction')): ?>
                                    <div class="col text-end">
                                        <a  data-url="<?php echo e(route('saturationdeductions.create', $employee->id)); ?>"
                                            data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create Saturation Deduction')); ?>"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                            data-bs-original-title="<?php echo e(__('Create')); ?>">
                                            <i class="ti ti-plus"></i>
                                        </a>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Overtime')): ?>
                                    <div class="col text-end">
                                        <a  data-url="<?php echo e(route('overtimes.create', $employee->id)); ?>"
                                            data-ajax-popup="true" data-title="<?php echo e(__('Create Overtime')); ?>"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                            data-bs-original-title="<?php echo e(__('Create')); ?>">
                                            <i class="ti ti-plus"></i>
                                        </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inditama/hr.inditama.co.id/resources/views/setsalary/employee_salary.blade.php ENDPATH**/ ?>