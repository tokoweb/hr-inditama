...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__("Job Catgory")); ?></li>
<?php $__env->stopSection(); ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Job Category')): ?>
        <a href="#" data-url="<?php echo e(route('job-category.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Job Category')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5960582/public_html/hr/resources/views/jobCategory/index.blade.php ENDPATH**/ ?>