    ...
    <div class="message-card" data-id="<?php echo e($id); ?>">
        ...
        <div>
            <div class="message-card">
                <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e($profile.'/'.$attachment[0]); ?>')">
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u5960582/public_html/hr/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>