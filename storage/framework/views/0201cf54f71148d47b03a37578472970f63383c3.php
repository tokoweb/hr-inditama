...
<script>
    ...
    // <?php $__currentLoopData = $contract->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    // var mockFile = {name: "<?php echo e($file->files); ?>", size: <?php echo e(\File::size(storage_path('contract_attechment/'.$file->files))); ?>};
    // myDropzone.emit("addedfile", mockFile);
    // myDropzone.emit("thumbnail", mockFile, "<?php echo e(asset('storage/contract_attechment/'.$file->files)); ?>");
    // myDropzone.emit("thumbnail", mockFile, "<?php echo e(asset(Storage::url('contract_attechment/'.$file->files))); ?>");
    // myDropzone.emit("complete", mockFile);
    // dropzoneBtn(mockFile, {download: "<?php echo e(route('contracts.file.download',[$contract->id,$file->id])); ?>", delete: "<?php echo e(route('contracts.file.delete',[$contract->id,$file->id])); ?>"});
    // <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5960582/public_html/hr/resources/views/contracts/show.blade.php ENDPATH**/ ?>