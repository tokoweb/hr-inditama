...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Role')): ?>
        <a href="#" data-url="<?php echo e(route('roles.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Role')); ?>"
            data-bs-toggle="tooltip" title="" data-size="lg" class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Create')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5960582/public_html/hr/resources/views/role/index.blade.php ENDPATH**/ ?>