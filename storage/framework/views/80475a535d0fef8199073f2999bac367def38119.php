                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class="form-group mb-3">
                                ...
                                <?php echo e(Form::text('name',null,array('class'=>'form-control','placeholder'=>__('Username')))); ?>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group mb-3">
                                ...
                                <?php echo e(Form::text('email',null,array('class'=>'form-control','placeholder'=>__('Email address')))); ?>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group mb-3">
                                ...
                                <?php echo e(Form::password('password',array('class'=>'form-control','id'=>'input-password','placeholder'=>__('Password')))); ?>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                <label class="form-label"><?php echo e(__('Confirm password')); ?></label>
                                    <?php echo e(Form::password('password_confirmation',array('class'=>'form-control','id'=>'confirm-input-password','placeholder'=>__('Confirm Password')))); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inditama/hr.inditama.co.id/resources/views/auth/register.blade.php ENDPATH**/ ?>