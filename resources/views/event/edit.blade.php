            ...
            <div class="form-group">
                ...
                <div class=" btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                    <label class="btn bg-info p-3 {{ $event->color == 'event-info' ? 'custom_color_radio_button
                        ' : '' }} "><input type="radio"
                            name="color" class="d-none" value="event-info" {{ $event->color == 'event-info' ? 'checked' : '' }}></label>

                    <label class="btn bg-warning p-3 {{ $event->color == 'event-warning' ? 'custom_color_radio_button' : '' }}"><input
                            type="radio"  class="d-none" name="color" value="event-warning"
                            {{ $event->color == 'event-warning' ? 'checked' : '' }}></label>

                    <label class="btn bg-danger p-3 {{ $event->color == 'event-danger' ? 'custom_color_radio_button' : '' }}"><input type="radio"
                            name="color" class="d-none" value="event-danger" {{ $event->color == 'event-danger' ? 'checked' : '' }}></label>


                    <label class="btn bg-success p-3 {{ $event->color == 'event-success' ? 'custom_color_radio_button' : '' }}"><input
                            type="radio" class="d-none" name="color" value="event-success"
                            {{ $event->color == 'event-success' ? 'checked' : '' }}></label>

                    <label class="btn p-3 {{ $event->color == 'event-primary' ? 'custom_color_radio_button' : '' }}" style="background-color: #51459d !important"><input
                            type="radio" class="d-none" name="color" value="event-primary"
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="btn-group btn-group-toggle btn-group-colors event-tag" data-toggle="buttons">
                        <label class="btn bg-info {{ $event->color == '#00B8D9' ? 'active' : '' }} "><input
                                type="radio" name="color" value="#00B8D9"
                                {{ $event->color == '#00B8D9' ? 'checked' : '' }}></label>
                        <label class="btn bg-warning {{ $event->color == '#FFAB00' ? 'active' : '' }}"><input
                                type="radio" name="color" value="#FFAB00"
                                {{ $event->color == '#FFAB00' ? 'checked' : '' }}></label>
                        <label class="btn bg-danger {{ $event->color == '#FF5630' ? 'active' : '' }}"><input
                                type="radio" name="color" value="#FF5630"
                                {{ $event->color == '#FF5630' ? 'checked' : '' }}></label>
                        <label class="btn bg-success {{ $event->color == '#36B37E' ? 'active' : '' }}"><input
                                type="radio" name="color" value="#36B37E"
                                {{ $event->color == '#36B37E' ? 'checked' : '' }}></label>
                        <label class="btn bg-secondary {{ $event->color == '#EFF2F7' ? 'active' : '' }}"><input
                                type="radio" name="color" value="#EFF2F7"
                                {{ $event->color == '#EFF2F7' ? 'checked' : '' }}></label>
                        <label class="btn bg-primary {{ $event->color == '#051C4B' ? 'active' : '' }}"><input
                                type="radio" name="color" value="#051C4B"
                                {{ $event->color == '#051C4B' ? 'checked' : '' }}></label>
                    </div>
                </div>
            </div>
        </div>
