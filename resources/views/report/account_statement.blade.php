                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2 ">
                            <div class="btn-box">
                                ...
                                <select class="form-control select" id="type" name="type" tabindex="-1" aria-hidden="true">
                                    <option value="income" {{ isset($_GET['account']) && $_GET['type'] == 'income' ? 'selected' : '' }}>
                                        {{ __('Income') }}</option>
                                    <option value="expense" {{ isset($_GET['account']) && $_GET['type'] == 'expense' ? 'selected' : '' }}>
                                        {{ __('Expense') }}</option>
                                </select>
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            <a href="{{ route('report.account.statement') }}" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        @else
                                            {{ __('Total Credit') }} :
                                        @endif {{ \Auth::user()->priceFormat($account->total) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
